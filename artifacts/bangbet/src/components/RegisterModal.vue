<template>
  <div class="cn-overlay" @click.self="$emit('close')">
    <div class="cn-modal">
      ...
      <div class="cn-group">
        <label class="cn-label">Promo Code <span style="font-weight:400;text-transform:none;color:#C4A882">(Optional)</span></label>
        <input v-model="promoCode" class="cn-input" type="text" placeholder="Enter promo code" />
      </div>
